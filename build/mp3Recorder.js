...
var getUserMedia = function getUserMedia(constraints) {
  if (navigator.mediaDevices) return navigator.mediaDevices.getUserMedia(constraints);

  var legacyUserMedia = (navigator.getUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia || navigator.webkitGetUserMedia).bind(navigator);

  return new Promise(function (res, rej) {
    return legacyUserMedia(constraints, res, rej);
  });
};
